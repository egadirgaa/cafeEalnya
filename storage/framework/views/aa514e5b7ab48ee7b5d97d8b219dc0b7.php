...
<div class="menu-wrapper">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <div>
            ...
            <p style="color: #a1887f; margin-top: 5px;">Total <span id="totalMenuCount"><?php echo e($menus->count()); ?></span> menu tersedia.</p>
        </div>
    </div>
    ...
    <?php else: ?>
        <div id="menuGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 25px;">
            ...
            <div class="menu-card searchable-item" data-name="<?php echo e(strtolower($menu->nama_menu)); ?>" data-category="<?php echo e(strtolower($menu->kategori)); ?>">
                <div class="category-tag" style="position: absolute; top: 15px; left: 15px; background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(8px); padding: 6px 14px; border-radius: 12px; font-size: 0.8rem; font-weight: 700; z-index: 2; color: #5d4037;">
                    <?php if(strtolower($menu->kategori) == 'minuman'): ?> ☕ 
                    <?php elseif(strtolower($menu->kategori) == 'makanan'): ?> 🍛 
                    <?php else: ?> 🍰 <?php endif; ?> 
                ...
                <div style="width: 100%; height: 200px; overflow: hidden;">
                    <img src="<?php echo e(str_contains($menu->gambar, 'menu/') ? asset('storage/' . $menu->gambar) : asset('storage/menu/' . $menu->gambar)); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                </div>

                <div style="padding: 20px; flex-grow: 1; display: flex; flex-direction: column;">
                    <h3 style="margin: 0 0 10px 0; font-size: 1.2rem; color: #4e342e;"><?php echo e($menu->nama_menu); ?></h3>
                    
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        <div>
                            <span style="display: block; font-size: 0.75rem; color: #a1887f; text-transform: uppercase;">Harga</span>
                            <span style="color: var(--secondary); font-weight: 800; font-size: 1.1rem;">Rp<?php echo e(number_format($menu->harga, 0, ',', '.')); ?></span>
                        </div>
                        <div style="text-align: right;">
                            <span style="display: block; font-size: 0.75rem; color: #a1887f; text-transform: uppercase;">Stok</span>
                            <span style="font-weight: 700; color: <?php echo e($menu->stok < 10 ? '#e53935' : '#43a047'); ?>;"><?php echo e($menu->stok); ?> pcs</span>
                        </div>
                    </div>

                    <div style="display: flex; gap: 10px; margin-top: auto;">
                        <a href="<?php echo e(route('admin.menu.edit', $menu->id)); ?>" style="flex: 1; text-align: center; padding: 10px; border-radius: 12px; background: #fff3e0; color: #ef6c00; text-decoration: none; font-weight: 700; font-size: 0.85rem;">✏️ Edit</a>
                        
                        <form action="<?php echo e(route('admin.menu.destroy', $menu->id)); ?>" method="POST" style="flex: 1;">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="button" 
                                    class="delete-menu-btn" 
                                    data-id="<?php echo e($menu->id); ?>" 
                                    data-name="<?php echo e($menu->nama_menu); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/egdrga/Documents/laravel/ealnya/ealnya/resources/views/admin/menu/index.blade.php ENDPATH**/ ?>