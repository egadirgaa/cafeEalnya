<?php $__env->startSection('title', 'Keranjang Cantikmu - Cafe Ealnya'); ?>
    ...
    <div id="cart-container">
        <?php if(count($keranjang) === 0): ?>
            <div id="empty-cart" style="text-align: center; padding: 50px;">
                ...
                <a href="<?php echo e(route('customer.pesanan.menu')); ?>" class="btn-custom btn-checkout" style="display: inline-flex; margin-top: 10px; width: auto;">
                    Cari Menu Enak ✨
                </a>
            </div>
        <?php else: ?>
            <div class="cart-list">
                <?php $__currentLoopData = $keranjang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="cart-item" id="item-<?php echo e($id); ?>">
                        <div class="item-info">
                            <h3><?php echo e($row['nama']); ?></h3>
                            <p>Rp <?php echo e(number_format($row['harga'], 0, ',', '.')); ?></p>
                        </div>
                        
                        <div class="qty-controls">
                            <button class="btn-qty" onclick="updateQty('<?php echo e($id); ?>', 'minus')">
                            ...
                            <span class="qty-number" id="qty-val-<?php echo e($id); ?>"><?php echo e($row['qty']); ?></span>
                            <button class="btn-qty" onclick="updateQty('<?php echo e($id); ?>', 'plus')">
                        ...
                        <div class="subtotal-text" id="subtotal-<?php echo e($id); ?>">
                            Rp <?php echo e(number_format($row['subtotal'], 0, ',', '.')); ?>

                        </div>

                        <button onclick="deleteItem('<?php echo e($id); ?>')" class="btn-delete" title="Hapus">
            ...
            <div class="checkout-card">
                <div class="summary-row">
                    ...
                    <span class="total-price" id="grand-total">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                </div>
...
<?php echo $__env->make('components.checkout-modal', ['total' => $total], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script>
    ...
    function updateQty(id, type) {
        fetch("<?php echo e(url('customer/keranjang/update')); ?>/" + id, {
            method: "POST",
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch("<?php echo e(url('customer/keranjang/hapus')); ?>/" + id, {
                    method: "POST",
    ...
    function clearCart() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch("<?php echo e(route('customer.pesanan.clear')); ?>", {
                    method: "POST",
                    headers: { "X-CSRF-TOKEN": csrfToken }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/egdrga/Documents/laravel/ealnya/ealnya/resources/views/customer/pesanan/index.blade.php ENDPATH**/ ?>