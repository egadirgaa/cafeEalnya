                ...
                <div id="payment-info-box" style="margin-top: 15px; padding: 15px; background: #fafafa; border-radius: 15px; border: 1px solid #eee;">
                    ...
                    <div id="info-qris" class="payment-detail">
                        <div style="text-align: center;">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CAFE-EAL-<?php echo e($total ?? 0); ?>" alt="QRIS" style="width: 130px; border-radius: 10px; border: 4px solid white; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
...
<script>
    ...
    function handleCheckout(e) {
        ...
        fetch("<?php echo e(route('customer.pesanan.prosesCheckout')); ?>", {
            method: "POST",
        ...
        .then(res => {
            if(res.ok) {
                ...
                setTimeout(() => window.location.href = "<?php echo e(route('customer.mutasi.index')); ?>", 2000);
            } else {
                btn.disabled = false;
...
</script><?php /**PATH /home/egdrga/Documents/laravel/ealnya/ealnya/resources/views/components/checkout-modal.blade.php ENDPATH**/ ?>