...
<body>
    ...
    <aside class="sidebar">
        <h1>Ealnya Admin 🎀</h1>
        <nav class="nav-menu">
            <a href="<?php echo e(route('customer.pesanan.menu')); ?>"  class="nav-link">
            ...
            <div class="nav-item-dropdown <?php echo e(Request::is('admin/menu*') ? 'active' : ''); ?>">
                ...
                <div class="submenu">
                    <a href="<?php echo e(route('admin.menu.index')); ?>" class="sub-link <?php echo e(Request::is('admin/menu') ? 'current' : ''); ?>">📜 Daftar Menu</a>
                    <a href="<?php echo e(route('admin.menu.create')); ?>" class="sub-link <?php echo e(Request::is('admin/menu/create') ? 'current' : ''); ?>">➕ Tambah Menu Baru</a>
                </div>
            </div>

            <a href="<?php echo e(route('admin.mutasi.index')); ?>" class="nav-link <?php echo e(Request::is('admin/mutasi') ? 'active' : ''); ?>">
                <svg viewBox="0 0 24 24">
...
</html><?php /**PATH /home/egdrga/Documents/laravel/ealnya/ealnya/resources/views/layouts/admin.blade.php ENDPATH**/ ?>