...
<div class="detail-wrapper">
    <div class="invoice-card">
        <div class="invoice-header">
            ...
            <div class="trx-id">Nota #TRX{{ str_pad($transaksi->id, 5, '0', STR_PAD_LEFT) }}</div>
        </div>
        ...
        <div class="invoice-body">
            <div class="info-section">
                <div class="info-box">
                    ...
                    <p>{{ $transaksi->user->name ?? 'Teman Ealnya' }}</p>
                </div>
                <div class="info-box">
                    <label>Tanggal</label>
                    <p>{{ \Carbon\Carbon::parse($transaksi->tanggal)->format('d M Y, H:i') }}</p>
                </div>
                <div class="info-box">
            ...
            <table class="item-table">
                ...
                <tbody>
                    @foreach($transaksi->pesanans as $item)
                    <tr>
                        <td class="item-name">☕ {{ $item->nama_menu }}</td>
    ...
    <div class="action-bar no-print">
        <a href="{{ route('admin.mutasi.index') }}" class="btn-action btn-back">
